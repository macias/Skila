...
namespace Skila.Language
{
    ...
    public abstract class NameReferenceSet : Node, INameReference
    {
            ...
            bool partialVirtualTables)
        {
            ...
            if (hasReference)
                aggregate_instance = ctx.Env.ReferenceType.GetInstance(new[] { aggregate_instance }, overrideMutability: MutabilityFlag.ConstAsSource, translation: null);
            else if (hasPointer)
                aggregate_instance = ctx.Env.PointerType.GetInstance(new[] { aggregate_instance }, overrideMutability: MutabilityFlag.ConstAsSource, translation: null);
